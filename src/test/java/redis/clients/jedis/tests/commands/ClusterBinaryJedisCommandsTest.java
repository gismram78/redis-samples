...
public class ClusterBinaryJedisCommandsTest extends JedisTestBase {
  ...
  public void testBinaryGetAndSet() {
    ...
    jedisCluster.set("foo", "2");
    assertEquals(jedisCluster.get("foo"), "2");
  }
  ...
  public void testIncr() {
    ...
    assertEquals(jedisCluster.get("foo"), "3");
  }

  @SuppressWarnings("unchecked")
  @Test
  public void testSadd() {
    String byteKey = "languages";
    String firstLanguage = "java";
    String secondLanguage = "python";
    String[] listLanguages = { firstLanguage, secondLanguage };
    jedisCluster.sadd(byteKey, listLanguages);
    Set<String> setLanguages = jedisCluster.smembers(byteKey);
    List<String> languages = new ArrayList<String>();
    for (String language : setLanguages) {
  ...
  public void testHmset() {
    String byteKey = "language";
    String language = "java";
    HashMap<String, String> map = new HashMap();
    map.put(byteKey, language);
    jedisCluster.hmset(byteKey, map);
    List<String> listResults = jedisCluster.hmget(byteKey, byteKey);
  ...
  public void testGetSlot() {
    assertEquals(JedisClusterCRC16.getSlot("{bar"), JedisClusterCRC16.getSlot("{bar"));
