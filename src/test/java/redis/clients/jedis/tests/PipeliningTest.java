...
public class PipeliningTest extends Assert {
  ...
  public void pipelineResponse() {
    ...
    Response<String> getrangeBytes = p.getrange("setrangebytes", 6, 8);
    p.sync();
    ...
    assertArrayEquals(expectedGetRangeBytes, getrangeBytes.get().getBytes());
  }
  ...
  public void testEvalWithBinary() {
    ...
    Pipeline p = jedis.pipelined();
    Response<String> result = p.eval(new String(SafeEncoder.encode(script)));
    p.sync();

    assertArrayEquals(SafeEncoder.encode("success!"), result.get().getBytes());
  }
  ...
  public void testEvalKeyAndArgWithBinary() {
    ...
    Response<String> bResult0 = bP.eval(new String(bScript), Arrays.asList(new String(bKey)), Arrays.asList(new String(bArg)));
    bP.incr(bKey);
    Response<String> bResult1 = bP.eval(new String(bScript), Arrays.asList(new String(bKey)), Arrays.asList(new String(bArg)));
  ...
  public void testEvalNestedLists() {
    ...
    Pipeline p = jedis.pipelined();
    Response<String> result = p.eval(script, 1, "key1");
    p.sync();
  ...
  public void testEvalNestedListsWithBinary() {
    ...
    Pipeline p = jedis.pipelined();
    Response<String> result = p.eval(bScript, 1, bKey);
    p.sync();
  ...
  public void testEvalshaKeyAndArgWithBinary() {
    ...
    Response<String> result0 = p.evalsha(bSha1, Arrays.asList(bKey), Arrays.asList(bArg));
    p.incr(bKey);
    Response<String> result1 = p.evalsha(bSha1, Arrays.asList(bKey), Arrays.asList(bArg));
